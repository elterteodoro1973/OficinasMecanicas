...
$(".c-form__treeview--parent input:checkbox").cbFamily(function () {
    return $(this).parents(".c-form__treeview--parent").next().find("input:checkbox");
});
$(".c-form__treeview--all input:checkbox").cbFamily(function () {
    return $(this).parents(".c-form__treeview").find("input:checkbox");
});